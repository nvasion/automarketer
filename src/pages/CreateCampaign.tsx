...
const TEMPLATE_POSTS: Record<Platform, string> = {
  ...
  bluesky: `Big news 🦋\n\nWe just launched something we've been building for months — and we're thrilled to finally share it.\n\nFast. Intuitive. Built for teams.\n\nEarly access is open now. Come check it out 👇`,
}
...
function CreateCampaign() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      console.error('[CreateCampaign] screenshot upload failed:', err)
